...
export default function Header() {
    return (
        ...
        >
            <div className="flex h-14 sm:h-16 items-center justify-between w-full rounded-xl bg-card border border-border px-4 sm:px-6">
                <a
                    href="https://sdad.pro"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="text-muted-foreground hover:text-foreground text-xs font-medium transition-colors hidden sm:block"
                >
                    sdad.pro
                </a>
